    ...
    <ul class="sidebar-menu">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li><a href="<?php echo site_url('dosen/dosen'); ?>"><i class="fa fa-reorder"></i>Dosen</a></li>
            </ul>
        </li>
        <li class="treeview">
           <a href="#">
           ...
           <ul class="treeview-menu">
               <li><a href="<?php echo site_url('dosen/ruangan'); ?>"><i class="fa fa-reorder"></i>Daftar Ruangan</a></li>
               <!-- <li><a href="<?php echo site_url('admin/matakuliah'); ?>"><i class="fa fa-reorder"></i>Mata Kuliah</a></li> -->
               <li><a href="<?php echo site_url('dosen/jadwalkuliah'); ?>"><i class="fa fa-table"></i>Jadwal Kuliah</a></li>
               <!-- <li><a href="<?php echo site_url('dosen/penelitian'); ?>"><i class="fa fa-table"></i>Penelitian</a></li> -->
           </ul>
        </li>
        <!-- <li class="treeview">
