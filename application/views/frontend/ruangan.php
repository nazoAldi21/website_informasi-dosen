...
<div class="wrapper">
    <div class="demo-header demo-header-image">
            <div class="motto">
                <h1 class="title-uppercase" style="padding-bottom: 3rem">Ruangan</h1>
                <h3></h3>
            </div>
    </div>
            ...
            <div class="col-md-10">
                ...
                <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                        <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
                            <li class="active"><a href="#terisi" data-toggle="tab">Terisi</a></li>
                            <li><a href="#kosong" data-toggle="tab">Kosong</a></li>
                        </ul>
                    </div>
                </div>
                <div id="my-tab-content" class="tab-content text-start">
                    <div class="tab-pane active" id="terisi">
                        <?php 
                        foreach ($get_ruangan_isi as $result1): ?>
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                <h5 class="card-title"><?php echo $result1['nama_ruang']; ?></h5>
                                <p class="card-text"><?php echo $result1['status_ruang']; ?></p>
                                <p class="card-text"><?php echo $result1['detail_ruang']; ?></p>
                    ...
                    <div class="tab-pane" id="kosong">
                        <?php 
                        foreach ($get_ruangan_kosong as $result): ?>
                        <div class="col-md-4">
                            <div class="card">
                                <img class="card-img-top" style="width: 100%;" src="<?php echo base_url(); ?>paper-kit-master/assets/paper_img/webinar.png" alt="Card image cap">
                                <div class="card-body">
                                <h5 class="card-title"><?php echo $result['nama_ruang']; ?></h5>
                                <p class="card-text"><?php echo $result['status_ruang']; ?></p>
                                <p class="card-text"><?php echo $result['detail_ruang']; ?></p>
                                <a href="#" class="btn btn-primary">Detail</a>
                                </div>
                            </div>
                        </div>
