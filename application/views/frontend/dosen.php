...
<div class="wrapper">
    <div class="demo-header demo-header-image">
            <div class="motto">
                <h1 class="title-uppercase" style="padding-bottom: 3rem">Profil Dosen</h1>
                <h3></h3>
            </div>
    </div>
            ...
            <div class="col-md-11">
                ...
                <div id="my-tab-content" class="tab-content text-start">
                    <div class="tab-pane active" id="terisi">
                        <?php 
                        foreach ($get_dosen_front as $result): ?>
                        <div class="col-md-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                <h5 class="card-title">Nama: <?php echo $result['nama_lengkap']; ?></h5>
                                <p class="card-text">NIDN: <?php echo $result['nidn']; ?></p>
                                <p class="card-text"><?php echo $result['ref_agama_id']; ?> </p>
                                <p class="card-text">Semester: <?php echo $result['no_telp']; ?></p>
                                </div>
                            </div>
                        </div>
                        <?php endforeach?>
